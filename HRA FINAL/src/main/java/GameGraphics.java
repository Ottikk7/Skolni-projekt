...
public class GameGraphics extends JPanel {
    ...
    GameLogic logic;
    BufferedImage bg1,bg2,bg3,bg4,bg5,bg6,bg7,bg8,bg9,PvP,PvE,titles, titleScreen,ruless;
    GameGraphics(GameLogic logic) {
        this.logic = logic;
        try {
            PvP = ImageIO.read(getClass().getResource("/PvP.png"));
            PvE = ImageIO.read(getClass().getResource("/PvE.png"));
    ...
    public void draw(Graphics g) {
        ...
        if(!logic.game){
            ...
            if(logic.secondPlayer){
                g.drawImage(PvP,600,400,200,200,null);
            }else{
                g.drawImage(PvE,600,400,200,200,null);
            }
